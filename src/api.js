...
const apiList = [
  //获取充值卡列表
  get('rechargeCard_getListByCon', 'rechargeCard/getListByCon'),
  //充值卡充值
  post('rechargeOrder_payOrder', 'rechargeOrder/payOrder',{ loading: '充值中', msg: '服务器繁忙...' }),
  //登陆
  post('user_login', 'user/login',{ loading: '登陆中', msg: '服务器繁忙...' }),
  //获取验证码
  post('common_sendVertifyCode', 'common/sendVertifyCode'),
  //公众号钱包页面聚合接口
  post('page_getWalletForOfficial', 'page/getWalletForOfficial'),
  //充值明细
  get('rechargeOrder_getListByCon', 'rechargeOrder/getListByCon'),
  //提现明细
  get('playerSettleApply_getListByCon', 'playerSettleApply/getListByCon'),
  //收入明细
  get('gameOrder_getListByCon', 'gameOrder/getListByCon'),
